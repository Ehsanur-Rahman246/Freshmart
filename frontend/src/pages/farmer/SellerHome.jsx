  ...
  return (
    <div className="min-h-screen bg-base-100 text-base-content">
      ...
      {/* =====================================================
          ...
          When Listings is opened, this entire section gets
          blurred underneath the white listings panel.
      ===================================================== */}
      ...
      >
        ...
        <header className="border-b border-theme bg-base-100">
